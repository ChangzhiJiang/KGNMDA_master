...
class KGCNMetric(Callback):
    def __init__(self, x_train, y_train,aggregator_type,dataset,K_fold):
    ...
    def on_epoch_end(self, epoch, logs=None):
        y_pred = self.model.predict(self.x_train).flatten()
        ...
        print(f'Logging Info - epoch: {epoch+1}, train_auc: {auc}, train_aupr: {aupr}, train_acc: {acc}, train_f1: {f1}')
